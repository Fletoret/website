...
# shared
default_width = (
    600  # iiif formatted size - https://iiif.io/api/image/2.1/#image-request-uri-syntax
)
...
class Manifest:
    ...
    def json_present(self):
        if not self.json:
            print(
                " ! please use the load_from_url(path_to_manifest) method before calling this method"
            )
            return False
        return True
