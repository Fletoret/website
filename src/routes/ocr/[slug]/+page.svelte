...
<svelte:head>
  <title>{data.book.title} — teksti i skanuar | Fletoret</title>
  <link rel="canonical" href="https://fletoret.com/ocr/{data.book.slug}/" />
  <meta
    name="description"
...
<main>
  <div class="book-title">
    <a href="/ocr/">← Të gjithë librat</a>
    <h1>{data.book.title}</h1>
    <p class="text-secondary">
      {[data.book.author, data.book.year].filter(Boolean).join(' · ')}
    </p>
  </div>
